             ...
             <ul className="">
                ...
                <div className="container img-field">
                    <div  ref={borderRef} className="d-flex justify-content-center align-items-center grad-border"></div>
                        <img className="col-xxl-1 col-xl-1 col-lg-1 col-md-1 col-sm-2 col-2" src="/images/react.png" alt="react logo" />
                </div>
                ...
                <div className="container img-field">
                    <div  ref={borderRefNd} className="d-flex justify-content-center align-items-center grad-border"></div>
                        <img className="col-xxl-1 col-xl-1 col-lg-1 col-md-1 col-sm-2 col-2" src="/images/laravel.png" alt="laravel logo" />
                </div>
                ...
                <div ref={containerRef}>
                    <img ref={logoRef} className="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-3 col-3 logo" src="/images/logo.png" alt="gsap logo" />
                </div>
            </ul>
